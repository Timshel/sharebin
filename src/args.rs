...
pub struct Args {
    #[clap(long, env = "SHAREBIN_BASIC_AUTH_USERNAME")]
    pub auth_basic_username: Option<String>,

    #[clap(long, env = "SHAREBIN_BASIC_AUTH_PASSWORD")]
    pub auth_basic_password: Option<String>,

    #[clap(long, env = "SHAREBIN_ADMIN_USERNAME", default_value = "admin")]
    pub auth_admin_username: String,

    #[clap(long, env = "SHAREBIN_ADMIN_PASSWORD", default_value = "m1cr0b1n")]
    pub auth_admin_password: String,

    #[clap(long, env = "SHAREBIN_EDITABLE")]
    pub editable: bool,

    #[clap(long, env = "SHAREBIN_FOOTER_TEXT")]
    pub footer_text: Option<String>,

    #[clap(long, env = "SHAREBIN_HIDE_FOOTER")]
    ...
    #[clap(long, env = "SHAREBIN_HIGHLIGHTSYNTAX")]
    pub highlightsyntax: bool,

    #[clap(short, long, env = "SHAREBIN_PORT", default_value_t = 8080)]
    pub port: u16,

    #[clap(short, long, env="SHAREBIN_BIND", default_value_t = IpAddr::from([0, 0, 0, 0]))]
    pub bind: IpAddr,

    #[clap(long, env = "SHAREBIN_PRIVATE")]
    pub private: bool,

    #[clap(long, env = "SHAREBIN_PURE_HTML")]
    pub pure_html: bool,

    #[clap(long, env = "SHAREBIN_JSON_DB")]
    pub json_db: bool,

    #[clap(long, env = "SHAREBIN_PUBLIC_PATH")]
    pub public_path: Option<PublicUrl>,

    #[clap(long, env = "SHAREBIN_SHORT_PATH")]
    pub short_path: Option<PublicUrl>,

    #[clap(long, env = "SHAREBIN_UPLOADER_PASSWORD")]
    pub uploader_password: Option<String>,

    #[clap(long, env = "SHAREBIN_READONLY")]
    pub readonly: bool,

    #[clap(long, env = "SHAREBIN_SHOW_READ_STATS")]
    pub show_read_stats: bool,

    #[clap(long, env = "SHAREBIN_TITLE")]
    pub title: Option<String>,

    #[clap(short, long, env = "SHAREBIN_THREADS", default_value_t = 1)]
    pub threads: u8,

    #[clap(short, long, env = "SHAREBIN_GC_DAYS", default_value_t = 90)]
    pub gc_days: u16,

    #[clap(long, env = "SHAREBIN_ENABLE_BURN_AFTER")]
    pub enable_burn_after: bool,

    #[clap(short, long, env = "SHAREBIN_DEFAULT_BURN_AFTER", default_value_t = 0)]
    pub default_burn_after: u16,

    #[clap(long, env = "SHAREBIN_WIDE")]
    pub wide: bool,

    #[clap(long, env = "SHAREBIN_QR")]
    pub qr: bool,

    #[clap(long, env = "SHAREBIN_ETERNAL_PASTA")]
    pub eternal_pasta: bool,

    #[clap(long, env = "SHAREBIN_ENABLE_READONLY")]
    pub enable_readonly: bool,

    #[clap(long, env = "SHAREBIN_DEFAULT_EXPIRY", default_value = "24hour")]
    pub default_expiry: String,

    #[clap(long, env = "SHAREBIN_DATA_DIR", default_value = "sharebin_data")]
    pub data_dir: String,

    #[clap(short, long, env = "SHAREBIN_NO_FILE_UPLOAD")]
    pub no_file_upload: bool,

    #[clap(long, env = "SHAREBIN_CUSTOM_CSS")]
    pub custom_css: Option<String>,

    #[clap(long, env = "SHAREBIN_HASH_IDS")]
    pub hash_ids: bool,
    ...
    #[clap(long, env = "SHAREBIN_ENCRYPTION_CLIENT_SIDE")]
    pub encryption_client_side: bool,

    #[clap(long, env = "SHAREBIN_ENCRYPTION_SERVER_SIDE")]
    pub encryption_server_side: bool,

    #[clap(
        long,
        env = "SHAREBIN_MAX_FILE_SIZE_ENCRYPTED_MB",
        default_value_t = 256
    )]
    ...
    #[clap(
        long,
        env = "SHAREBIN_MAX_FILE_SIZE_UNENCRYPTED_MB",
